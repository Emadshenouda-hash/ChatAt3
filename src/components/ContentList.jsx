        ...
        >
          ...
          {item.image && (
            <div className="aspect-video bg-gray-200 relative overflow-hidden">
              <img
                ...
                onError={(e) => {
                  e.target.src = `https://via.placeholder.com/600x400/e5e7eb/6b7280?text=${encodeURIComponent(item.title[language] || item.title.en)}`
                }}
              />
              {item.featured && (
          ...
          <div className="p-6">
            ...
            <p className="text-gray-600 mb-4 line-clamp-3">
              {item.excerpt?.[language] || item.description?.[language] || item.excerpt?.en || item.description?.en}
            </p>
